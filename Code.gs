...
var FIELDS = [
  ...
  // ส่วนที่ 3 (ความพึงพอใจ) — 5 ด้าน รวม 14 ข้อ (ฉบับปรับปรุงตามข้อเสนอแนะผู้ทรงคุณวุฒิ)
  // ด้านที่ 1 ความสวยงามและความน่าสนใจของสื่อ (s1-s3)
  's1','s2','s3',
  // ด้านที่ 2 ความชัดเจนและความรวดเร็วในการรับรู้ข้อมูล (s4-s7)
  's4','s5','s6','s7',
  // ด้านที่ 3 ความสามารถในการจดจำข้อมูล (s8-s10)
  's8','s9','s10',
  // ด้านที่ 4 การนำไปใช้ประโยชน์ (s11-s13)
  's11','s12','s13',
  // ด้านที่ 5 ความพึงพอใจโดยรวม (s14)
  's14',
  'sat_dim1_mean','sat_dim2_mean','sat_dim3_mean',
  'sat_dim4_mean','sat_dim5_mean','sat_overall_mean',
  // meta
